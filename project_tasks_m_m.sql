...
CREATE TABLE `project_tasks` (
  ...
  UNIQUE KEY `UK_7txclps991avka3ov7deot3ve` (`tasks_id`),
  KEY `FKrwqpj23ociawk68rbs6mooatw` (`project_id`)
...
INSERT INTO `project_tasks` VALUES ('P1','P1T1'),('P2','P2T1');
...
-- Dump completed on 2019-02-28 11:19:01
